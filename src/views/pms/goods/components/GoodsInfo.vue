    ...
    <div class="components-container__main">
      ...
      >
        <el-form-item label="商品名称" prop="name">
          <el-input v-model="value.name" style="width: 400px" />
        </el-form-item>

        <el-form-item label="原价" prop="originPrice">
          <el-input v-model="value.originPrice" style="width: 400px" />
        </el-form-item>

        <el-form-item label="现价" prop="price">
          <el-input v-model="value.price" style="width: 400px" />
        </el-form-item>
        ...
        <el-form-item label="商品简介">
          <el-input v-model="value.description" type="textarea" style="width: 400px" />
        </el-form-item>

        <el-form-item label="商品相册">
          <el-row :gutter="10">
            <el-col v-for="(item,index) in pictures" style="width: 180px">
              <el-card :body-style="{ padding: '10px' }">
                <single-upload v-model="item.url" />
                <div v-if="item.url" class="bottom">
                  <el-button v-if="item.main==true" type="text" class="button" style="color:#ff4d51">商品主图</el-button>
                  <el-button v-else type="text" class="button" @click="setMainPicture(index)">设为主图</el-button>
